...
| BGP-4 (Border Gateway Protocol 4) | [RFC 4271](https://datatracker.ietf.org/doc/html/rfc4271) | manually extract from section 8 of the rfc specification|
| PPP (Point-to-Point Protocol) | [RFC 1661](https://datatracker.ietf.org/doc/html/rfc1661#autoid-5) | manually extract the state machine from sections 3 and 4|
